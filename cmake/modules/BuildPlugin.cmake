# BuildPlugin.cmake - Copyright (c) 2008-2009 Tobias Doerffel
#
# description: build LMMS-plugin
# usage: BUILD_PLUGIN(<PLUGIN_NAME> <PLUGIN_SOURCES> MOCFILES <HEADERS_FOR_MOC> EMBEDDED_RESOURCES <LIST_OF_FILES_TO_EMBED> UICFILES <UI_FILES_TO_COMPILE> COMPONENT <COMPONENT_NAME>)
...
MACRO(BUILD_PLUGIN)
	PARSE_ARGUMENTS(PLUGIN "MOCFILES;EMBEDDED_RESOURCES;UICFILES;COMPONENT" "" ${ARGN} )
	...
	IF(NOT PLUGIN_COMPONENT)
		SET(PLUGIN_COMPONENT "Core")
	ENDIF(NOT PLUGIN_COMPONENT)

	INSTALL(TARGETS ${PLUGIN_NAME} LIBRARY DESTINATION "${PLUGIN_DIR}" COMPONENT ${PLUGIN_COMPONENT})
